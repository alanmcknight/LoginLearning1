list_field_user = list(tabPanel("Reports", dateRangeInput('dateRange1',
                                                           label = 'Sale Date range (yyyy-mm): ',
                                                           start = "2017-01-01", end = Sys.Date()
                                                          ),
                                selectInput("reportSelect", "Select Report", choices = c("Sales Report", "Quotezone Report", "MIS Report"), selected = "Sales Report"),
